...
const SearchForm: FC<SearchFormProps> = ({
  ...
  return (
    <form className="SearchForm">
      ...
      <div className="SearchForm__input-pokeball-submit">
      <input
        data-testid="input"
        id="search-input"
        className="SearchForm__input-pokeball-submit__input"
        placeholder="you better still the name : )"
      />
      ...
      <svg
        ...
        width="150"
        height="150"
        className="SearchForm__input-pokeball-submit__pokeball"
        data-testid='submit'
      >
